  ...
  return (
    <header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'py-2 md:py-3.5 bg-[#1a2a2c]/95 backdrop-blur-xl border-b border-white/10 shadow-2xl'
          : 'py-2.5 md:py-5 bg-gradient-to-b from-[#1a2a2c]/95 via-[#1a2a2c]/75 to-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2 sm:gap-4">
        ...
        >
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#c5a059] to-[#8a6d35] flex items-center justify-center shadow-lg shadow-black/40 group-hover:scale-105 transition-transform border border-[#c5a059]/40">
            <span className="font-takri text-xl sm:text-2xl text-[#1a2a2c] font-bold tracking-tight">𑚔</span>
          </div>
          <div>
            <div className="flex items-baseline">
              <h1 className="text-lg sm:text-2xl font-serif italic text-[#c5a059] tracking-tight group-hover:text-white transition-colors">
                {scriptMode === 'takri-only' ? (
                  <span className="font-takri text-xl sm:text-2xl font-bold not-italic">𑚩𑚮𑚢𑚪𑚭𑚘𑚯</span>
                ) : scriptMode === 'bilingual' ? (
                  <span>हिमवाणी</span>
                ) : (
                  <span>हिमवाणी <span className="text-white font-light text-base sm:text-xl ml-0.5 sm:ml-1 font-sans">Takri</span></span>
                )}
              </h1>
              <span className="text-[10px] sm:text-[11px] px-1.5 sm:px-2 py-0.5 ml-1.5 sm:ml-2 rounded-full bg-[#c5a059]/20 text-[#c5a059] border border-[#c5a059]/30 font-takri">
                𑚔𑚭𑚊𑚤𑚯
              </span>
            </div>
            <p className="text-[8px] sm:text-[10px] uppercase tracking-[0.15em] sm:tracking-[0.2em] text-white/60 font-sans hidden min-[380px]:block">
              {scriptMode === 'takri-only' ? (
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          <div id="script-mode-selector" className="flex items-center bg-black/40 rounded-xl p-0.5 sm:p-1 border border-white/10 text-[11px] sm:text-xs">
            <button
              id="lang-select-trilingual"
              onClick={() => setScriptMode('trilingual')}
              className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-[10px] sm:text-xs tracking-wider transition-all cursor-pointer font-semibold uppercase ${
            ...
            <button
              ...
              className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-[10px] sm:text-xs transition-all cursor-pointer flex items-center gap-1 font-medium ${
                scriptMode === 'bilingual'
            ...
            >
              ...
              <span className={`font-takri text-xs sm:text-sm font-bold ${scriptMode === 'bilingual' ? 'text-[#1a2a2c]' : 'text-[#dfbe7b]'}`}>
                𑚔𑚭𑚊𑚤𑚯
              </span>
            </button>
            <button
              ...
              className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg transition-all cursor-pointer flex items-center ${
                scriptMode === 'takri-only'
                  ? 'bg-[#c5a059] text-[#1a2a2c] font-bold shadow'
                  : 'text-white/70 hover:text-white'
              }`}
            ...
            >
              <span className={`font-takri text-xs sm:text-sm font-bold ${scriptMode === 'takri-only' ? 'text-[#1a2a2c]' : 'text-[#dfbe7b]'}`}>
                𑚔𑚭𑚊𑚤𑚯
              </span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2 relative">
            ...
            >
              {isMuted ? (
                ...
                <Volume2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#dfbe7b]" />
              )}
            </button>
          </div>
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-[#c5a059] hover:bg-white text-[#1a2a2c] font-bold text-xs shadow-lg shadow-black/30 transition-all hover:scale-102 cursor-pointer shrink-0"
          >
