...
export const HIMACHAL_SEASONS: Record<HimachalSeason, SeasonTheme> = {
  ...
  monsoon: {
    id: 'monsoon',
    nameEnglish: 'Monsoon Mist (Varsha)',
    nameHindi: 'वर्षा ऋतु (सावन-भादों)',
    nameTakri: '𑚦𑚤𑚋𑚭 𑚤𑚮𑚙𑚰',
    pahariMonths: 'Sawan – Bhadon (सावन - भादों)',
    calendarMonths: 'July – August',
    description: 'Lush emerald pine forests shrouded in swirling Himalayan fog, gushing Beas and Ravi rivers, and moss-blanketed ancient stone shrines.',
    accentColor: '#15803d', // Pine Forest Emerald
    accentLight: '#16a34a',
    accentDark: '#14532d',
    accentGlow: 'rgba(21, 128, 61, 0.18)',
    bodyBg: '#f0fdf4',
    bgGradientStart: '#f0fdf4',
    bgGradientMid: '#dcfce7',
    bgGradientEnd: '#f7fdf9',
    headerBg: 'rgba(240, 253, 244, 0.94)',
    cardBg: '#ffffff',
    cardBorder: '#bbf7d0',
    badgeBg: '#dcfce7',
    badgeBorder: '#86efac',
    ...
    buttonBg: '#15803d',
    buttonHover: '#14532d',
    buttonGradient: 'linear-gradient(135deg, #15803d, #14532d)',
    cardHighlight: 'rgba(22, 101, 52, 0.05)',
    headingColor: '#14532d',
    motifs: '🌧️ Misty Deodar Forests & Mountain Springs',
    icon: '🌧️',
  },
  autumn: {
    id: 'autumn',
